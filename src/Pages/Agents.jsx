...
function Agents() {
  return (
    <div className=" w-11/12 m-auto lg:max-w-screen-xl ">
      <div className="flex flex-col ">
        <div className="flex flex-col gap-4 py-20 md:pt-40 md:pb-0 lg:py-60 sm:flex-row ">
          <div className="flex md:flex-row shadow-sm bg-slate-50 p-4">
        ...
        <div className="flex flex-col gap-4 py-20 md:pt-40 md:pb-0 lg:py-40 sm:flex-row ">
          <div className="flex md:flex-row shadow-sm bg-slate-50 p-4">
            <div className="flex-1 font-secondary  flex flex-col gap-2">
              <div className="w-full relative group flex items-center justify-center ">
                <img
